...
export class ChatService {
  ...
  getChatMessageHistoryList(formData: any) {
    return this.http.post(environment.apiendpoint + 'table_chat_history', formData , { responseType: 'json' });
  }

  getChatMessages(formData: any) {
    return this.http.post(environment.apiendpoint + 'table_chats', formData , { responseType: 'json' });
  }
  ...
  deleteChatMessageHistory(formData: any) {
    return this.http.post(environment.apiendpoint + 'table_chat_delete', formData , { responseType: 'json' });
  }

  getSDAType(formData: any){
    return this.http.post(environment.apiendpoint + 'decision_making', formData , { responseType: 'json' });
  }

  getSDAVisualization(formData: any){
    return this.http.post(environment.apiendpoint + 'visualisation', formData , { responseType: 'json' });
  }
  ...
  saveFeedBack(formData: any){
    return this.http.post(environment.apiendpoint + 'table_feedback_toggle', formData , { responseType: 'json' });
  }
